...
def run_evolve():
    ...
    params['eval_mode'] = 2     # Evaluation mode: 0=pytorch_train, 1=synflow
...
class EvolveCNN(object):
    ...
    def do_work(self, params):
        ...
        eval_mode_str = {0: 'PyTorch Train', 1: 'Synflow', 2: 'Zen-NAS', 3: 'NASWOT', 4: 'Fisher', 5: 'GradNorm', 6: 'GraSP'}.get(eval_mode, 'Unknown')
