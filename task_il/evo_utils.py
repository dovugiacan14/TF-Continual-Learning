...
class Utils(object):
    ...
    @classmethod
    def read_grasp_template(cls):
        """Read template_grasp.py for GraSP-based evaluation"""
        script_dir = os.path.dirname(os.path.abspath(__file__))
        _path = os.path.join(script_dir, 'templates', 'template_grasp.py')
        part1 = []
        part2 = []
    ...
    @classmethod
    def generate_grasp_file(cls, indi):
        """Generate Python file using GraSP template for fast evaluation"""
        code = indi.code

        part1, part2 = cls.read_grasp_template()
        _str = []
        current_time = time.strftime("%Y-%m-%d  %H:%M:%S")
        _str.append('"""')
        _str.append(current_time)
        ...
        script_file_handler.flush()
        script_file_handler.close()
        Log.info('Generated grasp file: %s' % file_name)

    @classmethod
    def read_tass_template(cls):
        """Read template_tass.py for TASS-based evaluation"""
        script_dir = os.path.dirname(os.path.abspath(__file__))
        _path = os.path.join(script_dir, 'templates', 'template_tass.py')
        part1 = []
        part2 = []
    ...
    @classmethod
    def generate_tass_file(cls, indi):
        """Generate Python file using TASS template for CL-aware evaluation"""
        code = indi.code

        part1, part2 = cls.read_tass_template()
        _str = []
        current_time = time.strftime("%Y-%m-%d  %H:%M:%S")
        _str.append('"""')
        _str.append(current_time)
        ...
        script_file_handler.flush()
        script_file_handler.close()
        Log.info('Generated tass file: %s' % file_name)

    @classmethod
    def read_snip_template(cls):
        """Read template_snip.py for SNIP-based evaluation"""
        script_dir = os.path.dirname(os.path.abspath(__file__))
        _path = os.path.join(script_dir, 'templates', 'template_snip.py')
        part1 = []
        part2 = []
    ...
    @classmethod
    def generate_snip_file(cls, indi):
        """Generate Python file using SNIP template for fast evaluation"""
        code = indi.code

        part1, part2 = cls.read_snip_template()
        _str = []
        current_time = time.strftime("%Y-%m-%d  %H:%M:%S")
        _str.append('"""')
        _str.append(current_time)
        ...
        script_file_handler.flush()
        script_file_handler.close()
        Log.info('Generated snip file: %s' % file_name)
